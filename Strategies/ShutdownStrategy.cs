...
{
    internal class ShutdownStrategy : IShutdownStrategy
    {
        ...
        public ShutdownStrategy(IVideoPlayerService videoPlayerService, ISystemCommandService systemCommandService, string videoFilePath)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            await _systemCommandService.ExecuteCommandAsync(SystemCommand.Shutdown);
        }
    }
}
